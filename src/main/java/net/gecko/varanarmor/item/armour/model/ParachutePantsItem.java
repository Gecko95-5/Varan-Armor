...
public class ParachutePantsItem extends ArmorItem implements IAnimatable {
    private final AnimationFactory factory = GeckoLibUtil.createFactory(this);
    public ParachutePantsItem(ArmorMaterial material, EquipmentSlot slot, Settings settings) {
    ...
    private <P extends IAnimatable> PlayState predicate(AnimationEvent<P> event) {
        ...
        boolean isWearingAll = new HashSet<>(armorList).contains(ArmoryItems.PARACHUTE_PANTS);
