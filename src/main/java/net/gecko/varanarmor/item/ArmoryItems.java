...
public class ArmoryItems {
    ...
    public static final Item COPPER_WOODEN_SWORD = registerItem("copper_wooden_sword",
            new SwordItem(ArmoryToolMaterials.COPPER_WOOD, 3, -2.2F, new Item.Settings().group(ArmoryItemGroup.VARAN_ARMOR)));
    public static final Item COPPER_WOODEN_SHOVEL = registerItem("copper_wooden_shovel",
            new ShovelItem(ArmoryToolMaterials.COPPER_WOOD, 1.5F, -2.8F, new Item.Settings().group(ArmoryItemGroup.VARAN_ARMOR)));
    public static final Item COPPER_WOODEN_PICKAXE = registerItem("copper_wooden_pickaxe",
            new PickaxeItem(ArmoryToolMaterials.COPPER_WOOD, 1, -2.6F, new Item.Settings().group(ArmoryItemGroup.VARAN_ARMOR)));
    public static final Item COPPER_WOODEN_AXE = registerItem("copper_wooden_axe",
            new AxeItem(ArmoryToolMaterials.COPPER_WOOD, 6.0F, -3.0F, new Item.Settings().group(ArmoryItemGroup.VARAN_ARMOR)));
    public static final Item COPPER_WOODEN_HOE = registerItem("copper_wooden_hoe",
            new FixedHoeItem(ArmoryToolMaterials.COPPER_WOOD,0, -2.0F,  new Item.Settings().group(ArmoryItemGroup.VARAN_ARMOR)));
    ...
    public static final Item COPPER_STONE_SWORD = registerItem("copper_stone_sword",
            new SwordItem(ArmoryToolMaterials.COPPER_STONE, 3, -2.2F, new Item.Settings().group(ArmoryItemGroup.VARAN_ARMOR)));
    public static final Item COPPER_STONE_SHOVEL = registerItem("copper_stone_shovel",
            new ShovelItem(ArmoryToolMaterials.COPPER_STONE, 1.5F, -3.0F, new Item.Settings().group(ArmoryItemGroup.VARAN_ARMOR)));
    public static final Item COPPER_STONE_PICKAXE = registerItem("copper_stone_pickaxe",
            new PickaxeItem(ArmoryToolMaterials.COPPER_STONE, 1, -2.6F, new Item.Settings().group(ArmoryItemGroup.VARAN_ARMOR)));
    public static final Item COPPER_STONE_AXE = registerItem("copper_stone_axe",
            new AxeItem(ArmoryToolMaterials.COPPER_STONE, 7.0F, -3.0F, new Item.Settings().group(ArmoryItemGroup.VARAN_ARMOR)));
    public static final Item COPPER_STONE_HOE = registerItem("copper_stone_hoe",
            new FixedHoeItem(ArmoryToolMaterials.COPPER_STONE,-1, -1.0F,  new Item.Settings().group(ArmoryItemGroup.VARAN_ARMOR)));
    ...
    public static final Item COPPER_GOLDEN_SWORD = registerItem("copper_golden_sword",
            new SwordItem(ArmoryToolMaterials.COPPER_GOLD, 3, -2.2F, new Item.Settings().group(ArmoryItemGroup.VARAN_ARMOR)));
    public static final Item COPPER_GOLDEN_SHOVEL = registerItem("copper_golden_shovel",
            new ShovelItem(ArmoryToolMaterials.COPPER_GOLD, 1.5F, -2.8F, new Item.Settings().group(ArmoryItemGroup.VARAN_ARMOR)));
    public static final Item COPPER_GOLDEN_PICKAXE = registerItem("copper_golden_pickaxe",
            new PickaxeItem(ArmoryToolMaterials.COPPER_GOLD, 1, -2.6F, new Item.Settings().group(ArmoryItemGroup.VARAN_ARMOR)));
    public static final Item COPPER_GOLDEN_AXE = registerItem("copper_golden_axe",
            new AxeItem(ArmoryToolMaterials.COPPER_GOLD, 6.0F, -2.8F, new Item.Settings().group(ArmoryItemGroup.VARAN_ARMOR)));
    public static final Item COPPER_GOLDEN_HOE = registerItem("copper_golden_hoe",
            new FixedHoeItem(ArmoryToolMaterials.COPPER_GOLD, 0, -2.0F, new Item.Settings().group(ArmoryItemGroup.VARAN_ARMOR)));
    ...
    public static final Item COPPER_IRON_SWORD = registerItem("copper_iron_sword",
            new SwordItem(ArmoryToolMaterials.COPPER_IRON, 3, -2.2F, new Item.Settings().group(ArmoryItemGroup.VARAN_ARMOR)));
    public static final Item COPPER_IRON_SHOVEL = registerItem("copper_iron_shovel",
            new ShovelItem(ArmoryToolMaterials.COPPER_IRON, 1.5F, -2.8F, new Item.Settings().group(ArmoryItemGroup.VARAN_ARMOR)));
    public static final Item COPPER_IRON_PICKAXE = registerItem("copper_iron_pickaxe",
            new PickaxeItem(ArmoryToolMaterials.COPPER_IRON, 1, -2.6F, new Item.Settings().group(ArmoryItemGroup.VARAN_ARMOR)));
    public static final Item COPPER_IRON_AXE = registerItem("copper_iron_axe",
            new AxeItem(ArmoryToolMaterials.COPPER_IRON, 6.0F, -2.9F, new Item.Settings().group(ArmoryItemGroup.VARAN_ARMOR)));
    public static final Item COPPER_IRON_HOE = registerItem("copper_iron_hoe",
            new FixedHoeItem(ArmoryToolMaterials.COPPER_IRON, -2, 0.0F, new Item.Settings().group(ArmoryItemGroup.VARAN_ARMOR)));
    ...
    public static final Item COPPER_DIAMOND_SWORD = registerItem("copper_diamond_sword",
            new SwordItem(ArmoryToolMaterials.COPPER_DIAMOND, 3, -2.2F, new Item.Settings().group(ArmoryItemGroup.VARAN_ARMOR)));
    public static final Item COPPER_DIAMOND_SHOVEL = registerItem("copper_diamond_shovel",
            new ShovelItem(ArmoryToolMaterials.COPPER_DIAMOND, 1.5F, -2.8F, new Item.Settings().group(ArmoryItemGroup.VARAN_ARMOR)));
    public static final Item COPPER_DIAMOND_PICKAXE = registerItem("copper_diamond_pickaxe",
            new PickaxeItem(ArmoryToolMaterials.COPPER_DIAMOND, 1, -2.8F, new Item.Settings().group(ArmoryItemGroup.VARAN_ARMOR)));
    public static final Item COPPER_DIAMOND_AXE = registerItem("copper_diamond_axe",
            new AxeItem(ArmoryToolMaterials.COPPER_DIAMOND, 5.0F, -2.8F, new Item.Settings().group(ArmoryItemGroup.VARAN_ARMOR)));
    public static final Item COPPER_DIAMOND_HOE = registerItem("copper_diamond_hoe",
            new FixedHoeItem(ArmoryToolMaterials.COPPER_DIAMOND, -3, 1.0F, new Item.Settings().group(ArmoryItemGroup.VARAN_ARMOR)));
    ...
    public static final Item COPPER_WOODEN_SICKLE = registerItem("copper_wooden_sickle",
            new SickleItem(ArmoryToolMaterials.COPPER_WOOD, 1.75F, -1.9F, new Item.Settings().group(ArmoryItemGroup.VARAN_ARMOR)));
    ...
    public static final Item COPPER_STONE_SICKLE = registerItem("copper_stone_sickle",
            new SickleItem(ArmoryToolMaterials.COPPER_STONE, 1.75F, -1.9F, new Item.Settings().group(ArmoryItemGroup.VARAN_ARMOR)));
    ...
    public static final Item COPPER_GOLDEN_SICKLE = registerItem("copper_golden_sickle",
            new SickleItem(ArmoryToolMaterials.COPPER_GOLD, 1.75F, -1.9F, new Item.Settings().group(ArmoryItemGroup.VARAN_ARMOR)));
    ...
    public static final Item COPPER_IRON_SICKLE = registerItem("copper_iron_sickle",
            new SickleItem(ArmoryToolMaterials.COPPER_IRON, 1.75F, -1.9F, new Item.Settings().group(ArmoryItemGroup.VARAN_ARMOR)));
    ...
    public static final Item COPPER_DIAMOND_SICKLE = registerItem("copper_diamond_sickle",
            new SickleItem(ArmoryToolMaterials.COPPER_DIAMOND, 1.75F, -1.9F, new Item.Settings().group(ArmoryItemGroup.VARAN_ARMOR)));
    ...
    public static final Item COPPER_NETHERITE_SICKLE = registerItem("copper_netherite_sickle",
            new SickleItem(ArmoryToolMaterials.COPPER_NETHERITE, 1.75F, -1.9F,
                    new Item.Settings().group(ArmoryItemGroup.VARAN_ARMOR).fireproof()));
    ...
    public static final Item COPPER_WOODEN_CLAYMORE = registerItem("copper_wooden_claymore",
            new ClaymoreItem(ArmoryToolMaterials.HEAVY_COPPER_WOOD, 8, -3.2F, 600, 3,
                    new Item.Settings().group(ArmoryItemGroup.VARAN_ARMOR)));
    ...
    public static final Item COPPER_STONE_CLAYMORE = registerItem("copper_stone_claymore",
            new ClaymoreItem(ArmoryToolMaterials.HEAVY_COPPER_STONE, 9, -3.2F, 400, 3,
                    new Item.Settings().group(ArmoryItemGroup.VARAN_ARMOR)));
    ...
    public static final Item COPPER_GOLDEN_CLAYMORE = registerItem("copper_golden_claymore",
            new ClaymoreItem(ArmoryToolMaterials.HEAVY_COPPER_GOLD, 8, -3.2F, 200, 1,
                    new Item.Settings().group(ArmoryItemGroup.VARAN_ARMOR)));
    ...
    public static final Item COPPER_IRON_CLAYMORE = registerItem("copper_iron_claymore",
            new ClaymoreItem(ArmoryToolMaterials.HEAVY_COPPER_IRON, 8, -3.2F, 400, 2,
                    new Item.Settings().group(ArmoryItemGroup.VARAN_ARMOR)));
    ...
    public static final Item COPPER_DIAMOND_CLAYMORE = registerItem("copper_diamond_claymore",
            new ClaymoreItem(ArmoryToolMaterials.HEAVY_COPPER_DIAMOND, 7, -3.2F, 200, 2,
                    new Item.Settings().group(ArmoryItemGroup.VARAN_ARMOR)));
    ...
    public static final Item COPPER_NETHERITE_CLAYMORE = registerItem("copper_netherite_claymore",
            new ClaymoreItem(ArmoryToolMaterials.HEAVY_COPPER_NETHERITE, 7, -3.2F, 200, 1,
                    new Item.Settings().group(ArmoryItemGroup.VARAN_ARMOR).fireproof()));
