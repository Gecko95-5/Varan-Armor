...
public enum ArmoryToolMaterials implements ToolMaterial {
    ...
    COPPER_WOOD(0, 81, 2.0F, 0.0F, 15,
            () -> Ingredient.fromTag(ItemTags.PLANKS)),
    COPPER_STONE (1, 89, 4.0F, 1.0F, 5,
            () -> Ingredient.fromTag(ItemTags.STONE_TOOL_MATERIALS)),
    COPPER_GOLD (0, 44, 12.0F, 0.0F, 22,
            () -> Ingredient.ofItems(Items.GOLD_INGOT)),
    COPPER_IRON (2, 435, 6.0F, 2.0F, 14,
            () -> Ingredient.ofItems(Items.IRON_INGOT)),
    COPPER_DIAMOND (3, 1061,8.0F, 3.0F, 10,
            () -> Ingredient.ofItems(Items.DIAMOND)),
    COPPER_NETHERITE (4, 1381,9.0F, 4.0F, 15,
            () -> Ingredient.ofItems(Items.NETHERITE_INGOT)),
    ...
    HEAVY_COPPER_WOOD (0, 97,1.0F, 0.0F, 15,
            () -> Ingredient.fromTag(ItemTags.PLANKS)),
    HEAVY_COPPER_STONE (1, 126,3.0F, 1.0F, 5,
            () -> Ingredient.fromTag(ItemTags.STONE_TOOL_MATERIALS)),
    HEAVY_COPPER_GOLD (0, 53,11.0F, 0.0F, 22,
            () -> Ingredient.ofItems(Items.GOLD_INGOT)),
    HEAVY_COPPER_IRON (2, 505,5.0F, 2.0F, 14,
            () -> Ingredient.ofItems(Items.IRON_INGOT)),
    HEAVY_COPPER_DIAMOND (3, 1499,7.0F, 3.0F, 10,
            () -> Ingredient.ofItems(Items.DIAMOND)),
    HEAVY_COPPER_NETHERITE (4, 1950,8.0F, 4.0F, 15,
            () -> Ingredient.ofItems(Items.NETHERITE_INGOT)),
